declare namespace Kso {
    ...
    interface KsoCommandBarControls {
        Add(Type?: any, Id?: any, Parameter?: any, Before?: any, Temporary?: any, ppcbc?: KsoCommandBarControl): KsoCommandBarControl;
        ...
        **/
        ...
        Item(Index?: any, ppcbc?: KsoCommandBarControl): KsoCommandBarControl;
    ...
    interface KsoCommandBars {
        ...
        **/
        ...
        Add(Name?: any, Position?: any, MenuBar?: any, Temporary?: any, ppcb?: KsoCommandBar): KsoCommandBar;
        ...
        **/
        ...
        Item(Index?: any, ppcb?: KsoCommandBar): KsoCommandBar;
    ...
    interface KsoShape {
        ...
        * TextFrame
        **/
        readonly TextFrame: Wps.WpsTextFrame;
    ...
    interface KsoShapes {
        ...
        **/
        ...
        Item(Index?: any, Item?: KsoShape): KsoShape;
...
/* ====================== 全局声明 ====================== */
declare const CommandBars: Kso.KsoCommandBars;


/* ====================== 常用枚举值声明 ========== */
declare const msoControlButton: Kso.KsoMsoControlType.msoControlButton;
declare const msoFileDialogOpen: Kso.KsoMsoFileDialogType.msoFileDialogOpen;
declare const msoBarFloating: Kso.KsoMsoBarPosition.msoBarFloating;
declare const msoPropertyTypeString: Kso.KsoMsoDocProperties.msoPropertyTypeString
 ...
 *  暂仅支持：kwps.application 或 ket.application 或 kwpp.application
 * 示例
 * 跨组件数据互通，类似于在VBA编辑器中的CreateObject()的能力，一些典型的使用场景是围绕组件间的数据流转，比如把WPS表格中的统计数据自动插入到WPS文字文档或演示幻灯片中、把WPS文字中的表格类数据自动导入到WPS表格中等。
 */
declare function CreateObject(kwps: string): Wps.WpsApplication;
/**
 * 处理进程的消息队列中的消息。
 *  语法
 *  DoEvents()
 ...
 */
declare function DoEvents(): void;
/**
 * 弹出消息对话框，等待用户单击按钮，并返回一个整数，指示用户单击的哪个按钮。
 * @param prompt - 在对话框中显示的消息的字符串表达式。
 * @param buttons - 数值表达式，用于指定要显示按钮的数量和类型、要使用的图标样式、默认按钮的标识和消息框的形式的值（JSMsgBoxStyle）之和。
 * @param title - 对话框标题栏中显示的字符串表达式。
 * @returns 返回JSMsgBoxResult 枚举值，表示用户点击MsgBox弹出消息框的按钮。
 */
declare function MsgBox(prompt: string, buttons?: JSMsgBoxStyle, title?: string): JSMsgBoxResult;

/**
 * 指定MsgBox中按钮的数量、类型、图标样式和消息框的形式的枚举值。
 */
declare enum JSMsgBoxStyle {
    // 按钮常量
    jsOKOnly = 0,
    jsOKCancel = 1,
    jsAbortRetryIgnore = 2,
    jsYesNoCancel = 3,
    jsYesNo = 4,
    jsRetryCancel = 5,
    ...
    // 默认按钮常量
    jsDefaultButton1 = 0,
    jsDefaultButton2 = 256,
    jsDefaultButton3 = 512,
    jsDefaultButton4 = 768,

    // 消息框样式常量
    jsApplicationModal = 0,
    jsSystemModal = 4096,
    jsMsgBoxHelpButton = 16384,
}
// 为枚举值创建快捷访问声明
declare const jsOKOnly: JSMsgBoxStyle.jsOKOnly;
declare const jsOKCancel: JSMsgBoxStyle.jsOKCancel;
declare const jsAbortRetryIgnore: JSMsgBoxStyle.jsAbortRetryIgnore;
declare const jsYesNoCancel: JSMsgBoxStyle.jsYesNoCancel;
declare const jsYesNo: JSMsgBoxStyle.jsYesNo;
declare const jsRetryCancel: JSMsgBoxStyle.jsRetryCancel;

declare const jsCritical: JSMsgBoxStyle.jsCritical;
declare const jsQuestion: JSMsgBoxStyle.jsQuestion;
declare const jsExclamation: JSMsgBoxStyle.jsExclamation;
declare const jsInformation: JSMsgBoxStyle.jsInformation;

declare const jsDefaultButton1: JSMsgBoxStyle.jsDefaultButton1;
declare const jsDefaultButton2: JSMsgBoxStyle.jsDefaultButton2;
declare const jsDefaultButton3: JSMsgBoxStyle.jsDefaultButton3;
declare const jsDefaultButton4: JSMsgBoxStyle.jsDefaultButton4;

declare const jsApplicationModal: JSMsgBoxStyle.jsApplicationModal;
declare const jsSystemModal: JSMsgBoxStyle.jsSystemModal;
declare const jsMsgBoxHelpButton: JSMsgBoxStyle.jsMsgBoxHelpButton;
/**
 * 表示用户点击MsgBox弹出消息框的按钮。
 */
declare enum JSMsgBoxResult {
    jsOK = 1,
    jsCancel = 2,
    jsAbort = 3,
    jsRetry = 4,
...
declare const jsOK: JSMsgBoxResult.jsOK;
declare const jsCancel: JSMsgBoxResult.jsCancel;
declare const jsAbort: JSMsgBoxResult.jsAbort;
declare const jsRetry: JSMsgBoxResult.jsRetry;
declare const jsIgnore: JSMsgBoxResult.jsIgnore;
declare const jsYes: JSMsgBoxResult.jsYes;
declare const jsNo: JSMsgBoxResult.jsNo;
